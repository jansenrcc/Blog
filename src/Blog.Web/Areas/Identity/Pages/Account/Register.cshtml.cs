...
namespace Blog.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        [BindProperty]
        public RegisterUserDto Input { get; set; } // Alterando para RegisterUserDto
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Caso haja erros, adiciona-os ao ModelState
            ...
            return Page(); // Exibe novamente a página com mensagens de erro
        }
